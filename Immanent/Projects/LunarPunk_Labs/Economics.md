...
Examining economics in terms of nouns and verbs helps us to distinguish capital from currencies. Currencies (current-seas) are measures of value across time; where as capital arises from a concentrated aggrigiation these flows. In that regard we see two forms of measure; the qualitive and quantitive which then require evaluation against a baseline in order to become a codified form of capital. The representation, organisation and translation of such values becomes a deep set of scientific and technical challenges; how do we integrate them

From the qualitive perspective we are 
