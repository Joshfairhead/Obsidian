...
## Market Hypothesis
Before designing a such a tool, let's articulate some working assumptions about the market to approximate a set of enabling constraints. Here are the major market participants and then examine the forces which move them.
