...
Consequentially, both investor profiles are searching for new stores of value; a phenomena can be observed in their embrace of qualitive indicators like ESG. As always, there is a deal of controversy about the efficacy of such specific values. but both investor profiles are essentially stuck in a position where they need new investment vehicles that are values oriented AND profitable. Imperfect in themselves, ESG's have sufficient traction to suffice as a general set of values that help further constrain the north star of regeneration. 
