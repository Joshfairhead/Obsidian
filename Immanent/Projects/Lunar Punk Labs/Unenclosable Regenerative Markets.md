...
Alpha investors will generally be unsatisfied by the simplicity of noun like products; they hunt volitility in order to realise potential into profit. For regen markets this trait of potential realisation is desirable as it's a mechanism that can be harnessed. A control lever that steers the ship. 
