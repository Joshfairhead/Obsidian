...
Alpha investors will generally be unsatisfied by the simplicity of noun like products; they hunt volitility in order to realise potential into profit. This trait of potential actualisation is desirable for regen markets as it's a mechanism that can be harnessed. Lets ask ourselves, where is the most potential stored? As far as distribution graphs go it's the economic long tail.

This fact is not out of congruence with 
