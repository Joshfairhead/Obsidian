...
Alpha investors on the other hand will generally be unsatisfied by noun like products as they have little speculative alpha; these investors want an instrument with greater asymetry in the risk/reward ratio and higher potential for ROIs. From the perspective of building transformative financial products, risk and volitility will need to be baked in. Let us ask ourselves - when it comes to the socio-political ESG heuristic - from where can the most potential be realised? 
