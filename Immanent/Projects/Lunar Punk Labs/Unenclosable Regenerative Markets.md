...
Improving our ESG heuristic to a finer degree of resolution we can infer the values of Justice, Equity, Diversity and Inclusion. The two former terms are social values and the latter two are governance oriented. As we are dealing with people and place not only is it desirable to mitigate costs

To move the regenerative space forward they will not only need to mitigate their costs but explicate and internalise a set of community values. 
