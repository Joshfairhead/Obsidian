...
How do we open this market up? By enabling them to create their own credit classes based on local practices. The easiest path to adoption means following the institutional model of practicing a methodology, making projections about the outcome and taking measurements along the way. 
