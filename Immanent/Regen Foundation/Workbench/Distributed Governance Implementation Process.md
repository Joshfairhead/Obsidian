...
Given that we know the network is a complex adaptive system then any plan or cannoical source of truth is a necessary myth; a speculation on the future which eventually brings itself into existence. Whats the pAttempt at such a plan can only be a representitive snapshot riddled with immediacy bias!
