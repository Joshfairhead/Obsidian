...
The networks communication is immanently changing as the participants constantly adapt to the living world; a realm thats communicating rapidly all the time. VaueDid you know that every one of us emits a million biophotons a second with the strength of a candle light two miles in the distance and the intensity of a lazerbeam ~**Cosmic Serpent** (fact check the data is correct). 
