...
To bootstrap a registry it needs to be taken seriously, so we must onboard proven methodologies with sufficient scientific rigor first. Existence. Once the platform is functioning and has curated selection of methods with large degrees of prestige we can start loosening our criterea to include less western ways of thinking. After all most of the work being done globally will be done by the long tail; local practices. These smaller enterprises are excluded from 
