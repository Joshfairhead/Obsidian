...
In January we should setup and are scheduling a strategy workshop. Further to this thought we discussed the undertaking of these and the format. My offer is to use the three horizons framework to help navigate uncertainties in a specified do. This is the framework along with articulations of its functional purpose: https://resources.h3uni.org/tutorial/three-horizons/
